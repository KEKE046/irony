...
irony::constraint_def! {
    ...
    ConstraintEnum = {
        ...
        InstanceConstraint(InstanceConstraint ,
            ...
            super::cmt_utils::extract_input_types(env, target_region) == super::cmt_utils::extract_types(env, uses[0].1.to_owned())
            &&
            super::cmt_utils::extract_output_types(env, target_region) == super::cmt_utils::extract_types(env, defs[0].1.to_owned())
